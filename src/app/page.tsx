                    ...
                    <div className="grid gap-5 l:grid-cols-[1.3fr_0.88fr_0.88fr] l:items-start">
                        ...
                        <figure className="group overflow-hidden border border-white/8 bg-surface shadow-[0_24px_70px_rgba(0,0,0,0.45)]">
                            <div className="relative aspect-[4/5] overflow-hidden bg-black">
                                <Image src="/mambo.dance.png" alt="Salsa dancers inside the House of Mambo club" fill priority sizes="(max-width: 1023px) 100vw, 30vw" className="object-cover object-center transition-transform duration-700 group-hover:scale-[1.025]" />
                        ...
                        <figure className="group overflow-hidden border border-white/8 bg-surface shadow-[0_24px_70px_rgba(0,0,0,0.45)]">
                            <div className="relative aspect-[4/5] overflow-hidden bg-black">
                                <Image src="/Image+Shadow.png" alt="House of Mambo acoustic dance floor and lounge" fill priority sizes="(max-width: 1023px) 100vw, 30vw" className="object-cover object-center transition-transform duration-700 group-hover:scale-[1.03]" />
