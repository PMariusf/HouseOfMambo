                    ...
                    <div className="grid gap-10 l:grid-cols-[1fr_1fr] l:gap-8">
                        <div>
                            ...
                            <figure className="relative mt-7 aspect-[4/5] overflow-hidden border border-white/8 bg-black sm:aspect-[16/10]">
                                <Image src="/mambo-dance-main.webp" alt="The House of Mambo grand ballroom and lounge" fill loading="eager" quality={70} sizes="(max-width: 767px) calc(100vw - 2rem), (max-width: 1023px) calc(100vw - 4rem), 552px" className="object-cover object-[center_58%]" />
